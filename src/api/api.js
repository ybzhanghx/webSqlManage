...
export const getTableDataList = data => fetch(host + '/manage/funcList/getTableDataList', data, 'GET')
// export const getTableConfig = data => fetch(host + '/manage/funcList/getTableConfig', data, 'GET')
export const getTableConfig = data => fetch(host + '/manage/user/list', data, 'GET')
